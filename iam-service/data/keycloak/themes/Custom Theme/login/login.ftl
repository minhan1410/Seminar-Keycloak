...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "form">
        <div>
            <img class="logo" src="${url.resourcesPath}/img/intrust-logo.svg" alt="IntrustCA" style="width: 200px;" >
        </div>
        ...
        <div>
            <p class="copyright">&copy; Minh An tập custom login page for Keycloak. Copy của <a href="https://github.com/Alfresco/alfresco-keycloak-theme/tree/master">Alfresco</a></p>
        </div>
    </#if>
